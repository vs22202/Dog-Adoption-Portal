...
$router->post('/gallery', [HomeController::class, 'gallery']);
$router->get('/error', [HomeController::class, 'error']);
$router->get('/quiz', [HomeController::class, 'quiz']);
$router->post('/quiz', [HomeController::class, 'quiz']);
...
$router->get('/getlocation', [HomeController::class, 'getlocation']);
$router->get('/logout', [HomeController::class, 'logout']);
$router->get('/seemore', [HomeController::class, 'seemore']);
$router->resolve();
