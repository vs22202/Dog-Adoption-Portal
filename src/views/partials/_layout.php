    ...
    <nav>
        <ul class='navbar flex align-items-center justify-content-space-around'>
            ...
            <?php if (!isset($_SESSION['aduser']) && !isset($_SESSION['user'])) : ?>
                <li class='font-size-md margin-top-1'><a href="/login" class='btn primary-900 font-size-sm'>Login</a>
                    <hr> <a href="/signup" class='btn font-size-sm'>SignUp</a>
                </li>
            <?php endif ?>
            <?php if (isset($_SESSION['aduser']) || isset($_SESSION['user'])) : ?>
                <li class='font-size-md'>Welcome <?php echo $_SESSION['aduser'] ?? $_SESSION['user'] ?>
                    <hr> <a href="/logout" class='btn primary-900 font-size-sm'>Logout</a>
                </li>
            <?php endif ?>
        </ul>
    ...
    <footer class='flex footer gap1 width-90p margin-inline-auto margin-top-1 '>
        ...
        <nav class='flex gap1 font-family-grape font-size-md'>
            ...
            <div>
                <div>
                    <b>
                        <p class='margin-bottom-0-5'>Follow Social Links</p>
                    </b>
